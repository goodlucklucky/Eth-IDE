...
const overrides = [
  addWebpackAlias({
    ...
    '@goodlucklucky/welcome': `@goodlucklucky/${process.env.BUILD}-welcome`,
    '@goodlucklucky/header': `@goodlucklucky/${process.env.BUILD}-header`,
    '@goodlucklucky/bottombar': `@goodlucklucky/${process.env.BUILD}-bottombar`,
    '@goodlucklucky/compiler': `@goodlucklucky/${process.env.BUILD}-compiler`,
    '@goodlucklucky/project': `@goodlucklucky/${process.env.BUILD}-project`,
    '@goodlucklucky/contract': `@goodlucklucky/${process.env.BUILD}-contract`,
    '@goodlucklucky/explorer': `@goodlucklucky/${process.env.BUILD}-explorer`,
    '@goodlucklucky/network': `@goodlucklucky/${process.env.BUILD}-network`,
    '@goodlucklucky/node': `@goodlucklucky/${process.env.BUILD}-node`,
    '@goodlucklucky/sdk': `@goodlucklucky/${process.env.BUILD}-sdk`,
    '@goodlucklucky/premium-editor': path.resolve(
      __dirname,
  ...
  overrideProcessEnv({
    ...
    PROJECT_DESKTOP_URL: JSON.stringify('https://app.goodlucklucky.io/eth'),
    PROJECT_GITHUB_REPO: JSON.stringify(
      'https://github.com/goodlucklucky/Black-IDE'
    ),
    ...
    DOCKER_IMAGE_COMPILER: '"goodlucklucky/truffle"',
